...
public class EnlistMenuinDatabse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.enlist_menuin_databse_layout);
    ...
    private DatePickerDialog.OnDateSetListener dPickerListener
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            Toast.makeText(EnlistMenuinDatabse.this,day_x+"/"+month_x+"/"+year_x,Toast.LENGTH_SHORT).show();
            Log.d("myTag", dayName);
